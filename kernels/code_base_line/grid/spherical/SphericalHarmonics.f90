module SphericalHarmonics
  ...
  type, public :: T_lateralGrid
    ...
    procedure :: init_vcsv_sub  => init_vcsv_sub
    procedure :: vcsv_fn        => vcsv_fn

    procedure :: init_vcvv_sub => init_vcvv_sub
    procedure :: vcvv_fn       => vcvv_fn

    procedure :: init_vcvgv_sub => init_vcvgv_sub
    procedure :: vcvgv_fn       => vcvgv_fn

    procedure :: init_vcsv_vcvgv_sub => init_vcsv_vcvgv_sub
    procedure :: vcsv_vcvgv_fn       => vcsv_vcvgv_fn

    procedure :: init_vcsv_vcvv_vcvgv_sub => init_vcsv_vcvv_vcvgv_sub
    procedure :: vcsv_vcvv_vcvgv_sub      => vcsv_vcvv_vcvgv_sub
