submodule (lege_poly) step16f
  ...
  module procedure forward_legesum_16_sub
    ...
    allocate( pmj2(16), pmj1(16), pmj0(16), pmm(16), ssm(16*nf), asm(16*nf) )
    
    do m = 0, this%jmax
      call this%forward_rcb_16_sub( nf, rwork(1,3), sumN(1,1,1,m), sumS(1,1,1,m), ssm(1), asm(1) )
      
      !j = m
        mj = m*(this%jmax+1)-(m-2)*(m+1)/2
        
        call this%mmset_16_sub( mj, rwork(1,2), pmm(1), pmj2(1), pmj1(1), pmj0(1) )
        call this%forward_sum_16_sub( nf, pmj0(1), ssm(1), cr(1,mj) )
      
      do j = 1, (this%jmax-m)/2
        mj = mj+2
        
        call this%recursion_16_sub( mj-1, rwork(1,1), pmj2(1), pmj1(1), pmj0(1) )
        call this%forward_sum_16_sub( nf, pmj0(1), asm(1), cr(1,mj-1) )
        
        call this%recursion_16_sub( mj, rwork(1,1), pmj2(1), pmj1(1), pmj0(1) )
        call this%forward_sum_16_sub( nf, pmj0(1), ssm(1), cr(1,mj) )
      end do
