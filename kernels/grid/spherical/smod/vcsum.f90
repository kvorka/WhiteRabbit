  ...
  module pure subroutine vcsum_sub(this, cajm, cbjm, cjm)
    ...
    allocate( pmm(16), pmj(16), pmj1(16), pmj2(16), cosx(16), weight(16), sinx(16), ssym(32), asym(32), &
      ...
      do i = 1, (this%nLegendre/16)*16, 16
        ...
        call this%partial_backward_16_sub( 2, cosx(1), sinx(1), pmm(1), pmj2(1), pmj1(1), pmj(1), &
      ...
      do i = (this%nLegendre/16)*16+1, (this%nLegendre/8)*8, 8
        ...
        call this%partial_backward_8_sub( 2, cosx(1), sinx(1), pmm(1), pmj2(1), pmj1(1), pmj(1), &
                                         & ssym(1), asym(1), cc(1), sumN(1), sumS(1)               )
      ...
      do i = (this%nLegendre/8)*8+1, (this%nLegendre/4)*4, 4
        ...
        call this%partial_backward_4_sub( 2, cosx(1), sinx(1), pmm(1), pmj2(1), pmj1(1), pmj(1), &
                                        & ssym(1), asym(1), cc(1), sumN(1), sumS(1)               )
      ...
      do i = (this%nLegendre/4)*4+1, this%nLegendre, 2
        ...
        call this%partial_backward_2_sub( 2, cosx(1), sinx(1), pmm(1), pmj2(1), pmj1(1), pmj(1), &
                                        & ssym(1), asym(1), cc(1), sumN(1), sumS(1)               )
