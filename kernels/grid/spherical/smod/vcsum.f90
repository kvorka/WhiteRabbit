submodule (SphericalHarmonics) vcsum
  ...
  module pure subroutine vcsum_sub(this, cajm, cbjm, cjm)
    ...
    allocate( pmj(16), pmj1(16), pmj2(16), cosx(16), w(16), ssym(32), asym(32), &
            & sumN(32*this%jmax3), sumS(32*this%jmax3), grid(32*this%nFourier)  )
      
      !Stepping of the algorithm :: 16
      do i = 1, (this%nLegendre/16)*16, 16
        call this%partial_backward_16_sub( i, 2, cosx(1), pmj2(1), pmj1(1), pmj(1),  &
      ...
      do i = (this%nLegendre/16)*16+1, (this%nLegendre/8)*8, 8
        call this%partial_backward_8_sub( i, 2, cosx(1), pmj2(1), pmj1(1), pmj(1),  &
                                        & ssym(1), asym(1), cc(1), sumN(1), sumS(1) )
