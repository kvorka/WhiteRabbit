submodule (SphericalHarmonics) vctol
  ...
  module subroutine vctol_sub(this)
    ...
    real(kind=dbl),       allocatable   :: pmj(:), pmj1(:), pmj2(:), cosx(:), w(:)
    ...
    allocate( pmj(16), pmj1(16), pmj2(16), cosx(16), w(16), ssym(16), asym(16), &
            & sumN(16*this%jmax3), sumS(16*this%jmax3)                          )
    ...
    do
      ...
      do i = 1, (this%nLegendre/16)*16, 16
        call this%partial_backward_16_sub( i, 1, cosx(1), pmj2(1), pmj1(1), pmj(1),  &
                                         & ssym(1), asym(1), cc(1), sumN(1), sumS(1) )
        
        call this%partial_forward_16_sub( i, 1, w(1), cosx(1), pmj2(1), pmj1(1), pmj(1), &
                                        & ssym(1), asym(1), cr(1), sumN(1), sumS(1)      )
      end do
      
      !Stepping of the algorithm :: 8
      do i = (this%nLegendre/16)*16+1, (this%nLegendre/8)*8, 8
        call this%partial_backward_8_sub( i, 1, cosx(1), pmj2(1), pmj1(1), pmj(1),  &
                                        & ssym(1), asym(1), cc(1), sumN(1), sumS(1) )
        
        call this%partial_forward_8_sub( i, 1, w(1), cosx(1), pmj2(1), pmj1(1), pmj(1), &
                                       & ssym(1), asym(1), cr(1), sumN(1), sumS(1)      )
      end do
    ...
    deallocate( cr, cc, sumN, sumS, pmj, pmj1, pmj2, cosx, w, ssym, asym )
