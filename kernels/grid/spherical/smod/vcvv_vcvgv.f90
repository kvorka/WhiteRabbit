submodule (SphericalHarmonics) vcvv_vcvgv
  ...
  module pure subroutine vcvv_vcvgv_sub(this, ri, q, dv_r, v, cjm)
    ...
    integer                           :: i
    real(kind=dbl),       allocatable :: pmm(:), pmj(:), pmj1(:), pmj2(:), cosx(:), sinx(:), w(:), grid(:)
    ...
    allocate( pmm(16), pmj(16), pmj1(16), pmj2(16), cosx(16), w(16), sinx(16), ssym(240), &
            & asym(240), sumN(240*this%jmax3), sumS(240*this%jmax3), grid(240*this%nFourier)   )
      
      !Stepping of the algorithm :: 16
      do i = 1, (this%nLegendre/16)*16, 16
        call zero_carray_sub( 240*this%jmax3, sumN(1) )
        call zero_carray_sub( 240*this%jmax3, sumS(1) )
        ...
        call this%partial_forward_16_sub( 4, w(1), cosx(1), sinx(1), pmm(1), pmj2(1), pmj1(1), &
                                        & pmj(1), ssym(1), asym(1), cr(1), sumN(1), sumS(1)         )
      end do
      
      !Stepping of the algorithm :: 8
      do i = (this%nLegendre/16)*16+1, (this%nLegendre/8)*8, 8
        call zero_carray_sub( 120*this%jmax3, sumN(1) )
        call zero_carray_sub( 120*this%jmax3, sumS(1) )
        ...
        call this%partial_forward_8_sub( 4, w(1), cosx(1), sinx(1), pmm(1), pmj2(1), pmj1(1), &
                                       & pmj(1), ssym(1), asym(1), cr(1), sumN(1), sumS(1)         )
      end do
      
      !Stepping of the algorithm :: 4
      do i = (this%nLegendre/8)*8+1, (this%nLegendre/4)*4, 4
        call zero_carray_sub( 60*this%jmax3, sumN(1) )
        call zero_carray_sub( 60*this%jmax3, sumS(1) )
      ...
      do i = (this%nLegendre/4)*4+1, this%nLegendre, 2
        call zero_carray_sub( 30*this%jmax3, sumN(1) )
        call zero_carray_sub( 30*this%jmax3, sumS(1) )
