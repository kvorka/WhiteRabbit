submodule (lateral_grid) sgs
  ...
  module pure subroutine space_to_grid_sub(this, cc, grid)
    ...
    do i = 1, (this%nLegendre/16)*16, 16
      call this%lgp%backward_legesum_16_sub( 1, this%cosx(i), cc(1), sumN(1), sumS(1) )
    ...
    do i = (this%nLegendre/16)*16+1, (this%nLegendre/8)*8, 8
      call this%lgp%backward_legesum_8_sub( 1, this%cosx(i), cc(1), sumN(1), sumS(1) )
    ...
    do i = (this%nLegendre/8)*8+1, this%nLegendre, 4
      call this%lgp%backward_legesum_4_sub( 1, this%cosx(i), cc(1), sumN(1), sumS(1) )
  ...
  module pure subroutine grid_to_space_sub(this, grid, cr)
    ...
    do i = 1, (this%nLegendre/16)*16, 16
      ...
      call this%lgp%forward_legesum_16_sub( 1, this%cosx(i), this%weight(i), sumN(1), sumS(1), cr(1) )
    end do
    ...
    do i = (this%nLegendre/16)*16+1, (this%nLegendre/8)*8, 8
      ...
      call this%lgp%forward_legesum_8_sub( 1, this%cosx(i), this%weight(i), sumN(1), sumS(1), cr(1) )
    end do
    ...
    do i = (this%nLegendre/8)*8+1, this%nLegendre, 4
      ...
      call this%lgp%forward_legesum_4_sub( 1, this%cosx(i), this%weight(i), sumN(1), sumS(1), cr(1) )
    end do
