submodule (lateral_grid) vcss
  ...
  module procedure vcss_sub
    ...
    call this%reindexing%scal2scal_jm_to_mj_sub( cajm, cc, 2, 1 )
    call this%reindexing%scal2scal_jm_to_mj_sub( cbjm, cc, 2, 2 )
    
    !Transform
    call this%transform_sub( 1, 2, cc, cr, grid_op_vcss_sub )
