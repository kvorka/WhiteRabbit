module boundaries
  ...
  type, public :: T_boundaries
    integer                        :: jms
    complex(kind=dbl), allocatable :: temp_up(:), flux_up(:), flux_dn(:)
  ...
  interface
    ...
    module pure subroutine init_flux_dn_sub(this)
      class(T_boundaries), intent(inout) :: this
    end subroutine init_flux_dn_sub
