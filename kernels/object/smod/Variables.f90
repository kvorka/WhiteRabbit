submodule(PhysicalObject) Variables
  ...
  pure function dv_dr_rrjml_fn(this, ir, v) result(dv)
    ...
    dv = this%rad_grid%drr(ir,-1) * this%sol%velocity_jml_fn(ir-1) + &
  ...
  subroutine dv_dr_rr_jml_sub(this, ir, v, dv)
    ...
    allocate( v1(this%jmv), v2(this%jmv) ) ; call this%sol%velocity_jml_many_sub(ir-1, v1, v, v2)
  ...
  subroutine mgradT_rr_jml_sub(this, ir, T, gradT)
    ...
    allocate( flux1(this%jmv), flux2(this%jmv) ) ; call this%sol%flux_jml_many_sub(ir-1, T, flux1, flux2)
