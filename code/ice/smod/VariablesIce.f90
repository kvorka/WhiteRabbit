submodule(IceMod) VariablesIce
  ...
  module pure real(kind=dbl) function average_temperature_ice_ir_fn(this, ir)
    ...
    average_temperature_ice_ir_fn = this%Tu + ( this%Td-this%Tu ) * c2r_fn( this%temp_r_fn(ir,1) ) / s4pi
  ...
  module pure real(kind=dbl) function average_temperature_ice_irr_fn(this, ir)
    ...
    average_temperature_ice_irr_fn = this%Tu + ( this%Td-this%Tu ) * c2r_fn( this%temp_rr_fn(ir,1) ) / s4pi
  ...
  module pure real(kind=dbl) function average_stress_ice_ir_fn(this, ir)
    ...
    average_stress_ice_ir_fn = fac * sqrt( tensnorm2_fn(this%jmax, this%sol%deviatoric_stress_jml2_fn(ir)) ) / s4pi
  ...
  module pure real(kind=dbl) function average_stress_ice_irr_fn(this, ir)
    ...
    average_stress_ice_irr_fn = zero
