module IceCrustMod
  ...
  subroutine EE_iceCrust_sub(this, flux_bnd)
    ...
    subroutine EE_iceCrust_temp_sub(this, qConv, flux_bnd)
      ...
      allocate( ntemp(this%jms,2:this%nd) )
      
      !$omp parallel do
      do i = 2, this%nd
        ntemp(:,i) = -vgradT_fn(this,i)
      end do
      !$omp end parallel do
      ...
      !$omp parallel do
      do j = 1, this%jmax
        call this%mat%temp(j)%fill_sub( matica_temp_fn(this, j_in=j, a_in=1._dbl), matica_temp_fn(this, j_in=j, a_in=1._dbl)  )
      end do
      !$omp end parallel do
