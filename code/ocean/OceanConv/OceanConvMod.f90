module OceanConvMod
    ...
    private :: init_oceanConv_sub
    private :: init_state_oceanConv_sub
    private :: time_scheme_oceanConv_sub
    private :: vypis_oceanConv_sub
    private :: deallocate_oceanConv_sub
    ...
    subroutine init_oceanConv_sub(this)
      ...
      call init_state_oceanConv_sub(this); call vypis_oceanConv_sub(this)
  
    end subroutine init_oceanConv_sub
  
    subroutine init_state_oceanConv_sub(this)
      class(T_oceanConv), intent(inout) :: this
      ...
      call time_scheme_oceanConv_sub(this, cf=1._dbl)
  
    end subroutine init_state_oceanConv_sub
  
    subroutine iter_oceanConv_sub(this)
      class(T_oceanConv), intent(inout) :: this
      integer                           :: k
    ...
    subroutine vypis_oceanConv_sub(this)
      class(T_oceanConv), intent(inout) :: this
    ...
    end subroutine vypis_oceanConv_sub
